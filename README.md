# 🩺 SRE AI Agent Simulator
> Run autonomous incident response diagnostics. Trigger mock failures (memory leaks, deadlocks) and view the AI agent's reasoning traces and RCAs.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/sre-simulator/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/sre-simulator/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-sre-simulator.git
cd tp-sre-simulator
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/sre-simulator/) |
